...
- How to create React elements and how they are built up to create regular DOM
  elements.
- How children can be passed to a React element either with the 'children' prop
  or as more props following the children prop
