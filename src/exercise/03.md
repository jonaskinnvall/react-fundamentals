...
- How babel can be used to compile JSX syntax into JS and thus create React
  elements with a nicer syntax
- How JSX translates to React elements
- How to pass props to React elements using the 'interpolation' and the 'spread'
  operator
