...
- Style React components both with CSS classes but also inline
- I learned how a component can be built to take style and className as props
  and thus build differently styled versions of the same component
