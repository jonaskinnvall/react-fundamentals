...
- Create custom React components, both using React.createElement and with JSX
- How to use the prop-types library but also how that works by creating my own
  simple PropTypes to validate the props sent to my component
- What the React Fragment component is and what it can enable us to do
